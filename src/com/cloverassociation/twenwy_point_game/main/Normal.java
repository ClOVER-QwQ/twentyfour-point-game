...
public class Normal extends JFrame {
    ...
    public Normal() {
        ...
        normal.setTitle(FRAM_TITLE);
        normal.setSize(FRAM_WIDTH, FRAM_HIGHT);
        normal.setLocation(FRAM_X, FRAM_Y);
        normal.setResizable(false);
        normal.setVisible(true);
        normal.setContentPane(contentPanel);
